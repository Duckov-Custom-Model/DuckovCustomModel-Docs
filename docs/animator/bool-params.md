...
| Buff_Freeze                        | 1126 | 冰冻（移动速度与体力恢复速度降低）           |
| Buff_Frozen                        | 1127 | 冻结（无法移动，体力也无法恢复）             |
| Buff_Electric_NM                   | 1128 | 纳米机器（纳米机器人正在入侵）               |
| Buff_NM_Damage                     | 1129 | 机器入侵（被纳米机器人入侵了身体，不停损失生命，几乎无法治愈） |
| Buff_Buff_FoodPoison               | 1130 | 食物中毒（有些东西不能一起吃）               |
| Buff_NightVision                   | 1201 | 明视（略微增加夜间可见度）                   |
| Buff_PaperBox                      | 1202 | 伪装（站着不动，就没人能发现你）             |
| Buff_PaperBoxMelee                 | 1204 | 伪装                                         |
| Buff_DarkCarrot                    | 1205 | 1000%（感知+1000%，视野距离-1000%，陷入眩晕，持续7秒） |
| Buff_Tagilla                       | 1206 | Tagilla之力（大幅强化身体能力，但会持续流失生命值） |
| Buff_Tagilla_Basaka                | 1207 | 米诺陶之力（极大幅强化身体能力，但会持续流失大量生命值） |
...
| Buff_equip_BlueBall_Buff           | 1404 | 伞之力（持续恢复生命值，提高护甲、近战伤害与枪械伤害，进行攻击或受伤时会移除） |
| Buff_equip_RedBall_Buff            | 1405 | 红色圆球（提高近战与枪械伤害，攻击时移除）   |
| Buff_TwoBall_Layer                 | 1408 | 融合充能（持续充能到100层后会获得效果，但进行攻击都会打断充能） |
...
| Buff_Cold                          | 2101 | 寒冷（感到寒冷，移动能力，射击速度与冰属性抗性都会下降） |
| Buff_SuperCold                     | 2102 | 失温（体温水平开始低于安全线，运动机能全面下降） |
| Buff_HurtByCold                    | 2201 | 冻伤（持续流失生命值，冰属性抗性降低）       |
| Buff_ColdResist                    | 2301 | 抗寒（短时间内提高1级寒冷防护）              |
